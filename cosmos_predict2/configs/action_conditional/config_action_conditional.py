...
ACTION_CONDITIONAL_PREDICT2_VIDEO2WORLD_NET_14B = L(ActionConditionalMinimalV1LVGDiT)(
    max_img_h=240,
    max_img_w=240,
    max_frames=128,
    in_channels=16,
...
ACTION_CONDITIONAL_PREDICT2_VIDEO2WORLD_PIPELINE_14B = ActionConditionalVideo2WorldPipelineConfig(
    adjust_video_noise=True,
    conditioner=L(ActionConditionalConditioner)(
        fps=L(ReMapkey)(
            dropout_rate=0.0,
    ...
    min_num_conditional_frames=1,
    max_num_conditional_frames=1,
    net=ACTION_CONDITIONAL_PREDICT2_VIDEO2WORLD_NET_14B,
    precision="bfloat16",
    rectified_flow_t_scaling_factor=1.0,
    resize_online=True,
    resolution="720",
